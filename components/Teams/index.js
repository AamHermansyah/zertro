    ...
    return (
        <section id="team" className="mt-8">
            <div className="p-8 bg-white dark:bg-gray-800 rounded-lg shadow">
                ...
                <blockquote className="text-center mb-12 text-xl font-normal text-gray-500 dark:text-gray-200 italic">&ldquo;Hal besar dimulai dari kecil&rdquo;</blockquote>

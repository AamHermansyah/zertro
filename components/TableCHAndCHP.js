                    ...
                    <tbody className="text-center text-[.7rem] ss:text-base font-thin ss:font-normal">
                        ...
                        .map((res, index) => (
                            <tr className="text-gray-700 odd:bg-gray-200" key={index}>
                                ...
                                <td className="border-b-2 p-4 dark:border-dark-5">{index === 0 ? '-' : `$${res.open_price}`}</td>
